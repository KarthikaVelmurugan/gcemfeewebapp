        ...
        children: <Widget>[
          Container(
              ...
              child:Column(
                ...
                children: <Widget>[
                  Text('GCE -TJ MESS FEE SYSTEM',style:Style.style),
            ...
            child: Row(
              ...
              children: <Widget>[
                FlatButton(
                    ...
                    child:Text('Home',style: Style.substyle,),
                ...
                FlatButton(
                    ...
                    child:Text('Status',style: Style.substyle,),
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0)
                    ),
                    splashColor: Colors.white,
                ...
                FlatButton(
                    ...
                    child:Text('Verify',style: Style.substyle,),
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0)
                    ),
                    splashColor: Colors.white,
                ...
                FlatButton(
                    ...
                    child:Text('About',style: Style.substyle,),
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10.0)
                    ),
                    splashColor: Colors.white,
